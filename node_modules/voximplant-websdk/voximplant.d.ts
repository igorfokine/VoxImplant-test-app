...
declare module 'voximplant-websdk' {
    ...
    export { OperatorACDStatuses, LoginTokens, VideoFlags, LogRecord, QueueTypes, } from 'voximplant-websdk/Structures';
...
declare module 'voximplant-websdk/Client' {
    ...
    export class Client extends EventTarget<Events> implements VoxSignalingHandler {
            ...
            /**
                * Join to a conference without audio/video
                * @param num
                * @param extraHeaders
                */
...
declare module 'voximplant-websdk/Events' {
    ...
    export enum Events {
            ...
            /**
                ...
                * @see [Client.stopPlayback]
                */
            PlaybackFinished,
            /**
                * @deprecated
                * @typedef EventHandlers.MicAccessResult
                */
            MicAccessResult,
            /**
            ...
            ACDError,
            /**
                * The event is triggered when the Web SDK detects incorrect use of the SmartQueue module, e.g.,
                * using the same credentials in the different browsers or multiple browser's windows.
                * @hidden
                */
            SQError,
            /**
                * @beta Only accessible in the @next npm tag. You can switch active tag by the "npm i voximplant-websdk@next" command.
                */
            PlaybackError
    }
}
...
declare module 'voximplant-websdk/Call/CallEvents' {
    ...
    export enum CallEvents {
            ...
            /**
                ...
                * @typedef EventHandlers.CallEvent
                */
            ProgressToneStart,
            /**
            ...
            /**
                ...
                * @typedef EventHandlers.CallEvent
                * @deprecated Use [QualityIssueICEDisconnected] instead
                */
            ICETimeout,
            /**
            ...
            /**
                ...
                * @typedef EventHandlers.CallStatsReceived
                */
            CallStatsReceived,
            /**
            ...
            /**
                ...
                * @typedef EventHandlers.EndpointHandler
                */
            EndpointAdded,
            EndpointRemoved,
            /**
                * @typedef EventHandlers.StateUpdated
                */
            StateUpdated,
            /**
                * @typedef EventHandlers.ActiveUpdated
                */
            ActiveUpdated,
            /**
            ...
            /**
                ...
                * @beta
                * @typedef EventHandlers.ICEDisconnectedIssue
                */
            ...
            /**
                ...
                * @beta
                * @typedef EventHandlers.LocalVideoDegradationIssue
                */
            ...
            /**
                ...
                * @beta
                * @typedef EventHandlers.PacketLossIssue
                */
...
declare module 'voximplant-websdk/Call/EndPoints/EndpointEvents' {
    ...
    export enum EndpointEvents {
            ...
            /**
                * Event is triggered when an [Endpoint] is removed. E.g. when a participant left the conference or [player](/docs/references/voxengine/player) was removed.
                * @deprecated
                * @typedef EventHandlers.EndpointHandler
                */
            Removed = "Removed",
            /**
                ...
                * @typedef EventHandlers.EndpointMediaHandler
                */
            ...
            VoiceEnd = "VoiceEnd",
            /**
                * @typedef _MediaEndpointHandler
                */
            MediaRenderMute = "MediaRenderMute",
            /**
                * @typedef _MediaEndpointHandler
                */
            MediaRenderUnmute = "MediaRenderUnmute",
            /**
                * @typedef _MediaEndpointHandler
                */
    ...
    /**
        * @hidden
        */
    export interface EndpointEventsInterface {
            [EndpointEvents.VoiceStart]: _BaseEndpointHandler;
            [EndpointEvents.VoiceEnd]: _BaseEndpointHandler;
            [EndpointEvents.MediaRenderMute]: _MediaEndpointHandler;
            [EndpointEvents.MediaRenderUnmute]: _MediaEndpointHandler;
            [EndpointEvents.MediaRenderDisabled]: _MediaEndpointHandler;
            [EndpointEvents.MediaRenderEnabled]: _MediaEndpointHandler;
    }
    /**
        * @hidden
        */
    export interface _BaseEndpointHandler {
            endpoint: Endpoint;
    }
    /**
        * @hidden
        */
    export interface _MediaEndpointHandler extends _BaseEndpointHandler {
...
declare module 'voximplant-websdk/Structures' {
    ...
    /**
        ...
        *  For detailed information of ACD concept see the [Modules.ACD](/docs/introduction/introduction_to_voximplant/capabilities_and_components/calling_capabilities) documentation and the [appropriate HowTo's](/docs/howtos/acd).
        */
...
declare module 'voximplant-websdk/Call/Call' {
    ...
    /**
        * The Call class represents a single call, inbound or outbound. For outbound call it is retrieved from the [Client] class instance. For inbound call use a handler for the [IncomingCall] event.
        *
    ...
    export abstract class Call extends AbstractCall {
            ...
            /**
                * Answer the incoming call. There are two methods for an [IncomingCall]: [Call.answer] and [Call.decline]. Voice can be sended only after the [Call.answer] method call.
                * @param {String} customData Set custom string associated with call session. It can be later obtained from [Call History](/docs/references/httpapi/history#getcallhistory) using HTTP API, see the custom_data field in [result](/docs/references/httpapi/structure/callsessioninfotype). Custom data can be retrieved on the part of Voxengine via the [customData](/docs/references/voxengine/voxengine/customdata) method. Maximum size is 200 bytes.
            ...
            /**
                * Send tone (DTMF). It triggers the <a href="/docs/references/voxengine/callevents#tonereceived">CallEvents.ToneReceived</a> event in our cloud.
            ...
            get audioSenderTransform(): TransformStream;
            set audioSenderTransform(transform: TransformStream);
            get videoSenderTransform(): TransformStream;
            set videoSenderTransform(transform: TransformStream);
            /**
                * @hidden
                * @return {string}
                * @private
...
declare module 'voximplant-websdk/Media/MediaRenderer' {
    ...
    export class MediaRenderer {
            ...
            requestVideoSize(width: number, height: number): Promise<boolean>;
            videoSize: {
                    width: number;
                    height: number;
            };
            ...
            get receiverTransform(): TransformStream;
            set receiverTransform(transform: TransformStream);
    }
    export {};
}
...
declare module 'voximplant-websdk/Call/AbstractCall' {
    ...
    export abstract class AbstractCall extends EventTarget<CallEvents> implements SimpleCall {
            ...
            /**
                * @hidden
                */
            abstract onInfo(call: ViewerCall | Call, type: string, subType: string, body: string, headers: {
                    [id: string]: string;
            }): boolean;
            /**
                * @hidden
...
declare module 'voximplant-websdk/PeerConnection/PeerConnection' {
    ...
    export abstract class PeerConnection {
            ...
            abstract updateSenderTransformers(): void;
    }
}
